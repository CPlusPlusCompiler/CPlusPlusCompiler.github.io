import { useContext, useRef, useEffect, createElement } from 'react';
import { isFunction, isFullString, isString, isBoolean } from 'is-it-type';
import invariant from 'tiny-invariant';
import _createClass from '@babel/runtime/helpers/esm/createClass';
import { ABORT, ON_MOUNT, NO_SSR } from 'react-async-ssr/symbols';
import isPromise from 'is-promise';
import { I as IS_RESOURCE } from './constants.js';
import { v as validateOptions, g as getCacheVarFromOptions, S as ServerContext, a as getCacheVarFromOptionsWithValidate } from './shared.js';
...
var ResourceFactory = /*#__PURE__*/function () {
  ...
  _proto.use = function use(req) {
    ...
    if (IS_NODE) {
      var context = useContext(ServerContext);
...
export { createResourceFactory, isResource, preloadData, withResources };
